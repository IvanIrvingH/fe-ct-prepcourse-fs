...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Precio final ---> 8
   // Tu código:
  /*  objetoProducto['calcularPrecioDescuento']( let preFinal = objetoProducto.precio * objetoProducto.porcentajeDeDescuento => var final = objetoProducto.precio - preFinal);
   return final; */
